...
export default function BackgroundSettingsPanel(props) {
    ...
    return ( <
        PanelBody title = { __('Background settings', 'wdsblocks') }
        className = "block-editor-panel-color-gradient-settings" >
        {
...

            {
                'color' === backgroundType && ( <
                    ColorPaletteControl color = { backgroundColor }
...

            {
                'image' === backgroundType && ( <
                    MediaControl media = { backgroundImage }
...

            {
                'video' === backgroundType && ( <
                    MediaControl media = { backgroundVideo }
