    ...
    switch (type) {
        case 'video':
            return ( <
                ...
                autoPlay muted loop aria - hidden = "true" >
                <
...
export default function MediaControl(props) {
    ...
    return ( <
        ...
        <
        span className = "components-base-control__label" > { label } <
        /span> <
        MediaUploadCheck >
        <
        MediaUpload title = { label }
        onSelect = {
        ...
        render = {
            ({ open }) => ( <
                ...
                {!media && addLabel } {
                    !!media && ( <
                        ResponsiveWrapper naturalWidth = { media ? .width }
